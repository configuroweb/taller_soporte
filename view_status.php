...
if(isset($_GET['code'])){
    ...
    echo "<script>alert('El código de reparación es requerido'); location.replace('./');</script>";
}
?>
<style>
    @media screen {
                        ...
                        <div class="row">
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <?php else: ?>
                                        <span class="rounded-pill badge badge-dark bg-gradiend-dark ml-4">Sin-Pagar</span>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group col-md-4">
...
<script>
    $(function(){
        $('#delete_data').click(function(){
			_conf("Estás segur@ de eliminar <b><?= $code ?>\'s</b> de la reparaciones permanentemente","delete_repair",[$(this).attr('data-id')])
		})
    })
